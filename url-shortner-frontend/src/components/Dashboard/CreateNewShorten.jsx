    ...
    return (
        <div className="flex justify-center items-center bg-white rounded-md">
            <form
                ...
                className="sm:w-[450px] w-[360px] relative shadow-custom pt-8 pb-10 sm:px-8 px-4 rounded-lg"
            >
                ...
                <button
                    className="font-semibold text-white w-32 py-2 mt-5 transition bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90 rounded"
                    type="submit"
                >
